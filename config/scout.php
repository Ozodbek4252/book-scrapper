...
return [
    ...
    */
    ...
    'meilisearch' => [
        ...
        'index-settings' => [
            Book::class => [
                // Order is the tie breaker: a title match outranks an author
                // match, and both alphabets are listed so a search in either
                // one finds a book listed in the other.
                ...
                'filterableAttributes' => ['id', 'published_year', 'verified'],
                'sortableAttributes' => ['published_year'],
            ],
        ],
        'model-settings' => [
            // User::class => [
